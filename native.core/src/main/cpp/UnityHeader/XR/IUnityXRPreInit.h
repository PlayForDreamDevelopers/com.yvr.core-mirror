...
typedef enum UnityXRPreInitFlags
{
    ...
    /// Plugin supports late latching. The Engine core checks this flag before entering its late latching codepaths
    kUnityXRPreInitFlagsLateLatchingSupported = (1 << 5),
} UnityXRPreInitFlags;
